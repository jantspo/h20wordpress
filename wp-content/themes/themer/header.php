...
<html <?php language_attributes(); ?> class="no-js">
	...
	<body <?php body_class(); ?> data-spy="scroll" data-target=".navbar" id="top">
						...
						<div class="container">
							<div class="row">
								<div class=" col-md-2 col-lg-1 col-sm-offset-10 col-lg-offset-11">
									<a href="#" id="sign-in-large">Sign In</a>
								</div>
							</div>
										...
										<div class="row">
											<div class="col-xs-10 col-md-12">
												<a class="navbar-brand" href="#top">
													...
													<img src="../../wp-content/uploads/2015/02/h2obrand1.png" alt="Logo" class="logo-img">
								...
								<!-- Collect the nav links, forms, and other content for toggling -->
									<div class="collapse navbar-collapse" id="nav-collapse">
										<ul class="nav navbar-nav">
											...
											<?php endwhile; endif; ?>
											<li><a href="#" id="sign-in-mobile">Sign In</a></li>
										</ul>
									</div><!-- /.navbar-collapse -->
								</div>
							</div>
